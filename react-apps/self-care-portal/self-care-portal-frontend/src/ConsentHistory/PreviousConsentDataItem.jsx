...
import {PreviousConsentTableBody} from "./PreviousConsentTableBody";
import {PreviousConsentTableHeader} from "./PreviousConsentTableHeader";

export const PreviousConsentDataItem = ({permissionScope, consent, headerLang}) => {
                ...
                <Card className="clusterContainer">
                    ...
                    >
                        <Col className="clusterLabel">
                            <h6>View consent data existed prior to this Amendment</h6>
                        </Col>
                        <Col className="arrow">
                            <FontAwesomeIcon
                    ...
                    <Accordion.Collapse eventKey="0">
                        <Card.Body>
                            <PreviousConsentTableHeader
                                headerLang={headerLang}
                            />
                            <PreviousConsentTableBody
                                previousConsent={consent.previousConsentData}
                            />
                        </Card.Body>
                    </Accordion.Collapse>
                </Card>
