...
export const QRButton = (props) => {
  const {contextDeviceRegistrationData,getDeviceRegistrationContextInfo} = useContext(DeviceRegistrationContext);

  const deviceRegistrationData = contextDeviceRegistrationData;
