...
public class InvocationMetricsUnauthenticatedDTO {
    ...
    public InvocationMetricsUnauthenticatedDTO currentDay(BigDecimal currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public InvocationMetricsUnauthenticatedDTO previousDays(List<BigDecimal> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public InvocationMetricsUnauthenticatedDTO addPreviousDaysItem(BigDecimal previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class InvocationMetricsUnauthenticatedDTO {\n");
