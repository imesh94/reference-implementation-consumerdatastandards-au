...
public class RejectionMetricsV3AuthenticatedDTO {
    ...
    public RejectionMetricsV3AuthenticatedDTO currentDay(Integer currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public RejectionMetricsV3AuthenticatedDTO previousDays(List<Integer> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public RejectionMetricsV3AuthenticatedDTO addPreviousDaysItem(Integer previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class RejectionMetricsV3AuthenticatedDTO {\n");
