 ...
 **/
@ApiModel(description = "Percentage of unattended calls within the performance thresholds")
public class PerformanceMetricsV3UnattendedDTO {
    ...
    public PerformanceMetricsV3UnattendedDTO currentDay(List<String> currentDay) {
        this.currentDay = currentDay;
        return this;
    }

    public PerformanceMetricsV3UnattendedDTO addCurrentDayItem(String currentDayItem) {
    ...
    public PerformanceMetricsV3UnattendedDTO previousDays(List<List<String>> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public PerformanceMetricsV3UnattendedDTO addPreviousDaysItem(List<String> previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class PerformanceMetricsV3UnattendedDTO {\n");
