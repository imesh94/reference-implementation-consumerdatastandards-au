 ...
 **/
@ApiModel(description = "Transactions per second over time")
public class AverageTPSMetricsDTO {

    @ApiModelProperty(value = "Average TPS for current day")
    @Valid
    /**
    ...
    public AverageTPSMetricsDTO currentDay(BigDecimal currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public AverageTPSMetricsDTO previousDays(List<BigDecimal> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public AverageTPSMetricsDTO addPreviousDaysItem(BigDecimal previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class AverageTPSMetricsDTO {\n");
