...
public class InvocationMetricsLargePayloadDTO {
    ...
    public InvocationMetricsLargePayloadDTO currentDay(BigDecimal currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public InvocationMetricsLargePayloadDTO previousDays(List<BigDecimal> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public InvocationMetricsLargePayloadDTO addPreviousDaysItem(BigDecimal previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class InvocationMetricsLargePayloadDTO {\n");
