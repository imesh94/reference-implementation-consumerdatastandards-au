...
public class InvocationMetricsV3LowPriorityDTO {
    ...
    public InvocationMetricsV3LowPriorityDTO currentDay(Integer currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public InvocationMetricsV3LowPriorityDTO previousDays(List<Integer> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public InvocationMetricsV3LowPriorityDTO addPreviousDaysItem(Integer previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class InvocationMetricsV3LowPriorityDTO {\n");
