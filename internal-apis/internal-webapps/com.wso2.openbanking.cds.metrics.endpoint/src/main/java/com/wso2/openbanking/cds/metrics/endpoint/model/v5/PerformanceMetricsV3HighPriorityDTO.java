 ...
 **/
@ApiModel(description = "Percentage of high priority calls within the performance thresholds")
public class PerformanceMetricsV3HighPriorityDTO {
    ...
    public PerformanceMetricsV3HighPriorityDTO currentDay(List<String> currentDay) {
        this.currentDay = currentDay;
        return this;
    }

    public PerformanceMetricsV3HighPriorityDTO addCurrentDayItem(String currentDayItem) {
    ...
    public PerformanceMetricsV3HighPriorityDTO previousDays(List<List<String>> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public PerformanceMetricsV3HighPriorityDTO addPreviousDaysItem(List<String> previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class PerformanceMetricsV3HighPriorityDTO {\n");
