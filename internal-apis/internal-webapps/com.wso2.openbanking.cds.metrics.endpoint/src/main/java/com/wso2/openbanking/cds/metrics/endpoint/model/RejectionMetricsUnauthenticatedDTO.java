 ...
 **/
@ApiModel(description = "Rejection counts for all uauthenticated end points")
public class RejectionMetricsUnauthenticatedDTO  {
    ...
    public RejectionMetricsUnauthenticatedDTO currentDay(BigDecimal currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public RejectionMetricsUnauthenticatedDTO previousDays(List<BigDecimal> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public RejectionMetricsUnauthenticatedDTO addPreviousDaysItem(BigDecimal previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class RejectionMetricsUnauthenticatedDTO {\n");
