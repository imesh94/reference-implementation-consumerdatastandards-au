...
public class AverageResponseMetricsUnattendedDTO {
    ...
    public AverageResponseMetricsUnattendedDTO currentDay(BigDecimal currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public AverageResponseMetricsUnattendedDTO previousDays(List<BigDecimal> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public AverageResponseMetricsUnattendedDTO addPreviousDaysItem(BigDecimal previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class AverageResponseMetricsUnattendedDTO {\n");
