 ...
 **/
@ApiModel(description = "Peak transactions per second over time for unauthenticated endpoints")
public class PeakTPSMetricsV2UnauthenticatedDTO {
    ...
    public PeakTPSMetricsV2UnauthenticatedDTO currentDay(BigDecimal currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public PeakTPSMetricsV2UnauthenticatedDTO previousDays(List<BigDecimal> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public PeakTPSMetricsV2UnauthenticatedDTO addPreviousDaysItem(BigDecimal previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class PeakTPSMetricsV2UnauthenticatedDTO {\n");
