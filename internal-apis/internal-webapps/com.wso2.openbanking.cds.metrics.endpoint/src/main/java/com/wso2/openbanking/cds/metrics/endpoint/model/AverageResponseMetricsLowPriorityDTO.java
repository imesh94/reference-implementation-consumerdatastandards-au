 ...
 **/
@ApiModel(description = "Average response time for the low priority tier")
public class AverageResponseMetricsLowPriorityDTO {
    ...
    @ApiModelProperty(value = "Average response time for previous days. The first element indicates yesterday and " +
    ...
    public AverageResponseMetricsLowPriorityDTO currentDay(BigDecimal currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public AverageResponseMetricsLowPriorityDTO previousDays(List<BigDecimal> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public AverageResponseMetricsLowPriorityDTO addPreviousDaysItem(BigDecimal previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class AverageResponseMetricsLowPriorityDTO {\n");
