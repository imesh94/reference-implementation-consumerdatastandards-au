 ...
 **/
@ApiModel(description = "Availability metrics for the unauthenticated aspects of the CDR regime")
public class AvailabilityMetricsV2UnauthenticatedDTO {
    ...
    public AvailabilityMetricsV2UnauthenticatedDTO currentMonth(String currentMonth) {
        this.currentMonth = currentMonth;
        return this;
    }
    ...
    public AvailabilityMetricsV2UnauthenticatedDTO previousMonths(List<String> previousMonths) {
        this.previousMonths = previousMonths;
        return this;
    }

    public AvailabilityMetricsV2UnauthenticatedDTO addPreviousMonthsItem(String previousMonthsItem) {
    ...
    public String toString() {
        ...
        sb.append("class AvailabilityMetricsV2UnauthenticatedDTO {\n");
