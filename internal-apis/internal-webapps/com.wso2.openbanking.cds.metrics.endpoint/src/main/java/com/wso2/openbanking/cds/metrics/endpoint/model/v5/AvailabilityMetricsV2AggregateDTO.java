 ...
 **/
@ApiModel(description = "Aggregated availability metrics")
public class AvailabilityMetricsV2AggregateDTO {
    ...
    public AvailabilityMetricsV2AggregateDTO currentMonth(String currentMonth) {
        this.currentMonth = currentMonth;
        return this;
    }
    ...
    public AvailabilityMetricsV2AggregateDTO previousMonths(List<String> previousMonths) {
        this.previousMonths = previousMonths;
        return this;
    }

    public AvailabilityMetricsV2AggregateDTO addPreviousMonthsItem(String previousMonthsItem) {
    ...
    public String toString() {
        ...
        sb.append("class AvailabilityMetricsV2AggregateDTO {\n");
