...
/**
 * The number of authorisations where the customer successfully authenticated with a valid OTP or equivalent but
 * abandoned the process before selecting accounts
 **/
@ApiModel(description = "The number of authorisations where the customer successfully authenticated with a valid OTP " +
        "or equivalent but abandoned the process before selecting accounts")
public class AuthorisationMetricsV2AbandonmentsByStagePreAccountSelectionDTO {
    ...
    public AuthorisationMetricsV2AbandonmentsByStagePreAccountSelectionDTO currentDay(Integer currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public AuthorisationMetricsV2AbandonmentsByStagePreAccountSelectionDTO previousDays(List<Integer> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public AuthorisationMetricsV2AbandonmentsByStagePreAccountSelectionDTO addPreviousDaysItem(
    ...
    public String toString() {
        ...
        sb.append("class AuthorisationMetricsV2AbandonmentsByStagePreAccountSelectionDTO {\n");
