...
public class AverageResponseMetricsV2LowPriorityDTO {
    ...
    public AverageResponseMetricsV2LowPriorityDTO currentDay(BigDecimal currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public AverageResponseMetricsV2LowPriorityDTO previousDays(List<BigDecimal> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public AverageResponseMetricsV2LowPriorityDTO addPreviousDaysItem(BigDecimal previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class AverageResponseMetricsV2LowPriorityDTO {\n");
