 ...
 **/
@ApiModel(description = "Average transactions per second over time for authenticated endpoints")
public class AverageTPSMetricsV2AuthenticatedDTO {
    ...
    public AverageTPSMetricsV2AuthenticatedDTO currentDay(BigDecimal currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public AverageTPSMetricsV2AuthenticatedDTO previousDays(List<BigDecimal> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public AverageTPSMetricsV2AuthenticatedDTO addPreviousDaysItem(BigDecimal previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class AverageTPSMetricsV2AuthenticatedDTO {\n");
