...
public class InvocationMetricsV3UnattendedDTO {
    ...
    public InvocationMetricsV3UnattendedDTO currentDay(Integer currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public InvocationMetricsV3UnattendedDTO previousDays(List<Integer> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public InvocationMetricsV3UnattendedDTO addPreviousDaysItem(Integer previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class InvocationMetricsV3UnattendedDTO {\n");
