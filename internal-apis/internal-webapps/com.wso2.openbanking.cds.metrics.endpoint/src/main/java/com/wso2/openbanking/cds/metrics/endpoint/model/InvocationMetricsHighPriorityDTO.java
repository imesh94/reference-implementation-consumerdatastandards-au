...
public class InvocationMetricsHighPriorityDTO {
    ...
    public InvocationMetricsHighPriorityDTO currentDay(BigDecimal currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public InvocationMetricsHighPriorityDTO previousDays(List<BigDecimal> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public InvocationMetricsHighPriorityDTO addPreviousDaysItem(BigDecimal previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class InvocationMetricsHighPriorityDTO {\n");
