 ...
 **/
@ApiModel(description = "API call counts for the high priority tier")
public class InvocationMetricsV3HighPriorityDTO {
    ...
    public InvocationMetricsV3HighPriorityDTO currentDay(Integer currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public InvocationMetricsV3HighPriorityDTO previousDays(List<Integer> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public InvocationMetricsV3HighPriorityDTO addPreviousDaysItem(Integer previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class InvocationMetricsV3HighPriorityDTO {\n");
