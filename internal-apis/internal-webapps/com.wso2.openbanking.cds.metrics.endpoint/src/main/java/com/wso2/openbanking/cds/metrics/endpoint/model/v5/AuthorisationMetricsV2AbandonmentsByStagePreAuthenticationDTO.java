...
/**
 * The number of authorisations where the customer identified themselves (ie. they successfully identify the customer
 * profile to use for the authorisation) but failed to provide a valid OTP or equivalent
 **/
@ApiModel(description = "The number of authorisations where the customer identified themselves (ie. they successfully" +
        " identify the customer profile to use for the authorisation) but failed to provide a valid OTP or equivalent")
public class AuthorisationMetricsV2AbandonmentsByStagePreAuthenticationDTO {
    ...
    public AuthorisationMetricsV2AbandonmentsByStagePreAuthenticationDTO currentDay(Integer currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public AuthorisationMetricsV2AbandonmentsByStagePreAuthenticationDTO previousDays(List<Integer> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public AuthorisationMetricsV2AbandonmentsByStagePreAuthenticationDTO addPreviousDaysItem(Integer previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class AuthorisationMetricsV2AbandonmentsByStagePreAuthenticationDTO {\n");
