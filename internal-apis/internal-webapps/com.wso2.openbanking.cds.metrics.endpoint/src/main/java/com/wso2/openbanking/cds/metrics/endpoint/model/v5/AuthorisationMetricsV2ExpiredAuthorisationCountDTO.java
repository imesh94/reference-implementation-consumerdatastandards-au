 ...
 **/
@ApiModel(description = "The number of expired ongoing authorisations")
public class AuthorisationMetricsV2ExpiredAuthorisationCountDTO {

    @ApiModelProperty(value = "")
    @Valid
    private AuthorisationMetricsV2AuthorisationCountDayDTO currentDay = null;

    @ApiModelProperty(value = "Number of expired authorisations for previous days. The first element indicates " +
            "yesterday and so on. A maximum of seven entries is required if available")
    @Valid
    /**
     * Number of expired authorisations for previous days. The first element indicates yesterday and so on. A maximum
    ...
    public AuthorisationMetricsV2ExpiredAuthorisationCountDTO currentDay(
    ...
    public AuthorisationMetricsV2ExpiredAuthorisationCountDTO previousDays(
            List<AuthorisationMetricsV2AuthorisationCountDayDTO> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public AuthorisationMetricsV2ExpiredAuthorisationCountDTO addPreviousDaysItem(
    ...
    public String toString() {
        ...
        sb.append("class AuthorisationMetricsV2ExpiredAuthorisationCountDTO {\n");
