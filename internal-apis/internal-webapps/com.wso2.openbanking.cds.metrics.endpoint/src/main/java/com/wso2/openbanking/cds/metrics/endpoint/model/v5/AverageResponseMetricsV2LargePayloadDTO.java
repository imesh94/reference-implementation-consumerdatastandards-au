...
public class AverageResponseMetricsV2LargePayloadDTO {
    ...
    public AverageResponseMetricsV2LargePayloadDTO currentDay(BigDecimal currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public AverageResponseMetricsV2LargePayloadDTO previousDays(List<BigDecimal> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public AverageResponseMetricsV2LargePayloadDTO addPreviousDaysItem(BigDecimal previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class AverageResponseMetricsV2LargePayloadDTO {\n");
