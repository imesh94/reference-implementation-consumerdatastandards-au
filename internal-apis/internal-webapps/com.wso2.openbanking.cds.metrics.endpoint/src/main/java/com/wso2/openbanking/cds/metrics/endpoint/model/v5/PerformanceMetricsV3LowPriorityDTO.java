 ...
 **/
@ApiModel(description = "Percentage of low priority calls within the performance thresholds")
public class PerformanceMetricsV3LowPriorityDTO {
    ...
    public PerformanceMetricsV3LowPriorityDTO currentDay(List<String> currentDay) {
        this.currentDay = currentDay;
        return this;
    }

    public PerformanceMetricsV3LowPriorityDTO addCurrentDayItem(String currentDayItem) {
    ...
    public PerformanceMetricsV3LowPriorityDTO previousDays(List<List<String>> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public PerformanceMetricsV3LowPriorityDTO addPreviousDaysItem(List<String> previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class PerformanceMetricsV3LowPriorityDTO {\n");
