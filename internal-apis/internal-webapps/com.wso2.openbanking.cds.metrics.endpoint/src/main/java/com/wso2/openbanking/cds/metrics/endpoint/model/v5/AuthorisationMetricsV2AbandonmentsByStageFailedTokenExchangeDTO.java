...
/**
 * The number of authorisations that completed the interactive flow with the consumer authorising the consent, but
 * the ADR failed to - or was unable to - obtain a refresh or access token using the authorisation code
 **/
@ApiModel(description = "The number of authorisations that completed the interactive flow with the consumer " +
        "authorising the consent, but the ADR failed to - or was unable to - obtain a refresh or access token using " +
        "the authorisation code")
public class AuthorisationMetricsV2AbandonmentsByStageFailedTokenExchangeDTO {
    ...
    public AuthorisationMetricsV2AbandonmentsByStageFailedTokenExchangeDTO currentDay(Integer currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public AuthorisationMetricsV2AbandonmentsByStageFailedTokenExchangeDTO previousDays(List<Integer> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public AuthorisationMetricsV2AbandonmentsByStageFailedTokenExchangeDTO addPreviousDaysItem(
            Integer previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class AuthorisationMetricsV2AbandonmentsByStageFailedTokenExchangeDTO {\n");
