 ...
 **/
@ApiModel(description = "Average response time for the large payload tier")
public class AverageResponseMetricsLargePayloadDTO {
    ...
    @ApiModelProperty(value = "Average response time for previous days. The first element indicates yesterday " +
            "and so on. A maximum of seven entries is required if available.")
    @Valid
    /**
     * Average response time for previous days. The first element indicates yesterday and so on. A maximum of
    ...
    public AverageResponseMetricsLargePayloadDTO currentDay(BigDecimal currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public AverageResponseMetricsLargePayloadDTO previousDays(List<BigDecimal> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public AverageResponseMetricsLargePayloadDTO addPreviousDaysItem(BigDecimal previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class AverageResponseMetricsLargePayloadDTO {\n");
