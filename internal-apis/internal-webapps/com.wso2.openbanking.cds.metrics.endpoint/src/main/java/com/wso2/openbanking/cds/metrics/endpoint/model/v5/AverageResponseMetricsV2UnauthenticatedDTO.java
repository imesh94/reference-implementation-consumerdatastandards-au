...
public class AverageResponseMetricsV2UnauthenticatedDTO {
    ...
    public AverageResponseMetricsV2UnauthenticatedDTO currentDay(BigDecimal currentDay) {
        this.currentDay = currentDay;
        return this;
    }
    ...
    public AverageResponseMetricsV2UnauthenticatedDTO previousDays(List<BigDecimal> previousDays) {
        this.previousDays = previousDays;
        return this;
    }

    public AverageResponseMetricsV2UnauthenticatedDTO addPreviousDaysItem(BigDecimal previousDaysItem) {
    ...
    public String toString() {
        ...
        sb.append("class AverageResponseMetricsV2UnauthenticatedDTO {\n");
