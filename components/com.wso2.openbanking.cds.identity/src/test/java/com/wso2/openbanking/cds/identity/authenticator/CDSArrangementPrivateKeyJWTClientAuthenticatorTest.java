...
/**
 * Test class for CDS Arrangement Private Key JWT Authenticator.
 */
...
public class CDSArrangementPrivateKeyJWTClientAuthenticatorTest extends PowerMockTestCase {
    ...
    @Test(description = "Test whether can authenticate is engaged for arrangement revocation request")
    public void canAuthenticateTest() throws Exception {
        ...
        CDSArrangementPrivateKeyJWTClientAuthenticator authenticator =
                PowerMockito.spy(new CDSArrangementPrivateKeyJWTClientAuthenticator());
        Map<String, List> bodyParams = new HashMap<>();
        request.setRequestURI("baseUri/arrangements");
