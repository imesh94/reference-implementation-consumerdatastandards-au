...
public class ApplicationAccessTokenDto {
  ...
  /**
   * Method to generate the Payload for Application Access token without client assertion.
   * @param clientId client id
   * @return payload
   */
  public String getPayloadWithoutClientAssertion(String clientId) {
  ...
  /**
   * Method to generate the Payload for Application Access token without client assertion type.
   * @param clientId client id
   * @return payload
   * @throws TestFrameworkException exception
   */
  ...
  /**
   * Method to generate the Payload for Application Access token of Non-Regulatory Client.
   * @param clientId client id
   * @return payload
   */
  public String getPayloadForNonRegulatoryClient(String clientId) {
