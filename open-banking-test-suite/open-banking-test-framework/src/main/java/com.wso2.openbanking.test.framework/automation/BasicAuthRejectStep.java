 ...
 */
public class BasicAuthRejectStep implements BrowserAutomationStep {

  public String authorizeUrl;
  private static final Log log = LogFactory.getLog(BasicAuthRejectStep.class);
   ...
   */
  public BasicAuthRejectStep(String authorizeUrl) {
