...
public class BrowserAutomation {
    ...
    /**
     * Initialize automation harness. Use this constructor if need to use the same session for a consecutive
     * authorisation
     *
     * @param stepDelaySeconds      delay between steps.
     * @param useSameBrowserSession value to indicate whether to use the same drive object instead of creating a
     *                              new one
     */
