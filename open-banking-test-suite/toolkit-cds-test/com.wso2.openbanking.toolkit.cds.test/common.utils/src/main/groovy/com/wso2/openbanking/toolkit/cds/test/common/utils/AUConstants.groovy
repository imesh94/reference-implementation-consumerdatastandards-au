...
class AUConstants {
    ...
    static final String accountID = "qu4WMZ-59LsndgjMN-kikFfJL4Z87VlRvoxej0mrh307U-WM2t9RagzY82qc7_xZVn-Agk_K8WIAWdgTgofMvmR-Kl9_PaageLbaVzytdVHpEudIRSQDvUivfs6FvgrA"
    static final String accountID2 = "qu4WMZ-59LsndgjMN-kikFfJL4Z87VlRvoxej0mrh33jm9OC5hnFFpVjCHirvpVGXcVo1GqNjL_PTaCcjZPe-lHCZx_QOOT_PIMnZSWijYkBTvXlMLnFszvdN28n3WWA"
    ...
    static final String SOLUTION_VERSION_300 = "3.0.0"
...
//   static final ERROR_X_V_MISSING = "Mandatory header x-v is missing"
    ...
    static final ERROR_X_V_MISSING = "Mandatory header x-v is missing"
    static final ERROR_ENDPOINT_VERSION4 = "Requested endpoint version 4 is not supported"
    static final  ERROR_ENDPOINT_VERSION5= "Requested endpoint version 5 is not supported"
    ...
    static final INVALID_RESOURCE = "Invalid Resource"
    ...
    static final ERROR_CODE_INVALID_RESOURCE = "urn:au-cds:error:cds-all:Resource/Invalid"
    ...
    static final ERROR_CODE_RESOURCE_NOTFOUND = "urn:au-cds:error:cds-all:Resource/NotFound"
