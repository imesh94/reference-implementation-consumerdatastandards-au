...
class AUDCRConstants {
    ...
    static final WITHOUT_TOKEN_ENDPOINT_SIGNINGALGO = "Required parameter tokenEndPointAuthSigningAlg cannot be null"
    static final WITHOUT_TOKEN_ENDPOINT_AUTHMETHOD = "Required parameter tokenEndPointAuthentication cannot be null"
    static final GRANT_TYPES_NULL = "Required parameter grantTypes cannot be null"
    static final WITHOUT_RESPONSE_TYPES = "Required parameter responseTypes cannot be null"
    static final WITHOUT_SSA = "Required parameter software statement cannot be null"
    static final WITHOUT_ID_TOKEN_RESPONSE_ALGO = "Required parameter idTokenEncryptionResponseAlg cannot be null"
    static final WITHOUT_ID_TOKEN_ENCRYPTION_ALGO= "Required parameter idTokenEncryptionResponseAlg cannot be null"
    static final WITHOUT_ID_TOKEN_ENCRYPTION_METHOD= "Required parameter idTokenEncryptionResponseEnc cannot be null"
    static final INVALID_ID_TOKEN_ENCRYPTION_ALGO= "Invalid idTokenEncryptionResponseAlg provided"
    static final INVALID_ID_TOKEN_ENCRYPTION_METHOD= "Invalid idTokenEncryptionResponseEnc provided"
    static final INVALID_REDIRECT_URI = "invalid_redirect_uri"
    static final INVALID_REDIRECT_DESCRIPTION = "Invalid callbackUris provided"
